...
public final class Workflow
{
  ...
  private class WorkflowExecutor
  {
    public Object execute(final ExecutionContext context, final Object source)
    {
      ...
      // TODO: Ajey - Handle infinite loops. Consumer should take care of such situations but good to guards against it here. But might be difficult and will need higher value of iterations or configurable value to determine if we have infinite loop. 
